...
export const serviceAreas: ServiceArea[] = [
  {
    ...
    fullDescription: 'Lawton is the largest city we serve and home to Fort Sill. We provide comprehensive dumpster rental services for residential renovations, commercial construction, military housing projects, and large-scale cleanup operations. Our veteran-owned business understands the unique needs of the Lawton community.',
    population: '~92,000',
    highlights: [
      'Fort Sill military base support',
